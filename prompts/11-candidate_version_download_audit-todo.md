...
- [ ] Rename data classes to more descriptive names
...
- [ ] Extract the actual distribution inference to a well-named method on Version
...
- [ ] Move audit conversion logic to AuditRequest/AuditCommand
...
- [ ] Remove deprecated readSavedAuditRecord method
...
- [ ] Add test cases for null host and user agent
...
- [ ] Create DownloadResponse class for REST responses
